...
![serpl](https://repo.x-cmd.io/serpl.svg?lang=zh)
...
- **上游仓库**: <https://github.com/yassinebridi/serpl>
- **许可证**: MIT
...
- **Star**: 856 · **Fork**: 13 · **开放 issue**: 30 · **贡献者**: 8

## 累计统计

- **发布数**: 29 · **已合并 PR**: 16 · **开放 PR**: 1 · **已关闭 issue**: 9 · **开放 issue**: 21 · **提交数**: 143
...
在 [repology.org](https://repology.org/project/serpl) 上共有 **13** 个发行版报告此项目。**8** 个 ✅ 已是最新上游版本，**5** 个 ⚠️ 使用旧版本。
...
serpl 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `serpl` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/serpl.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T20:21:50Z._
